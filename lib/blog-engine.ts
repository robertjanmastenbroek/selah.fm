...
PLATFORM CONTEXT: Selah.fm is an open source CPM marketplace for music promotion. Artists set budgets and CPM rates, creators make TikTok/Reel/Short videos, artists approve and pay for verified views. A 20% platform fee is added on top of the artist CPM rate. Creators earn the full CPM rate with no deductions.
