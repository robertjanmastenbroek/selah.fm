                ...
                <>
                  ...
                  {contentAssetsUrl && (
                    <a
                      ...
                      className="flex items-center gap-3 rounded-xl bg-primary/[0.04] border border-primary/10 p-3 hover:border-primary/20 transition-colors group"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-semibold text-primary group-hover:underline">Download audio & assets</p>
                        <p className="text-[10px] text-muted-foreground">.mp3, .wav, images, reference videos from the artist</p>
                      </div>
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-primary/40 shrink-0"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                    </a>
                  )}
