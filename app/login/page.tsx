    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        {forgotMode ? (
          ...
          <>
            <button onClick={handleGoogleSignIn} className="flex items-center justify-center gap-2 w-full border rounded-xl py-3 text-sm font-medium hover:bg-muted transition-colors">
