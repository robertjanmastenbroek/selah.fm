  ...
  return (
    <html lang={locale} className={cn("font-sans", poppins.variable, righteous.variable)}>
      ...
      <body className="min-h-screen bg-background overflow-x-hidden">
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-3 focus:left-3 focus:z-[10000] focus:px-4 focus:py-2 focus:bg-primary focus:text-primary-foreground focus:rounded-lg focus:text-sm focus:font-medium focus:outline-none">Skip to content</a>
        ...
        <NextIntlClientProvider locale={locale} messages={messages}>
          ...
          <footer className="border-t border-white/[0.04] py-5 px-4">
            <div className="flex items-center justify-center gap-5 flex-wrap">
              ...
              <a href="/pricing" className="text-[11px] text-muted-foreground/40 hover:text-muted-foreground transition-colors">Pricing</a>
              <span className="text-muted-foreground/15 select-none">·</span>
