...
function ShareModal({ open, onClose, url, title, artistName, cpmDollars, trackTitle }: {
  ...
  const platforms = [
    ...
    { name: 'Instagram', href: `https://www.instagram.com/`, color: '#E4405F',
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="5" fill="none" stroke="currentColor" strokeWidth="1.5"/><circle cx="17" cy="7" r="2" fill="currentColor"/></svg> },
    ...
    { name: 'Messenger', href: `https://www.messenger.com/share?link=${encodedUrl}`, color: '#00B2FF',
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 4.975 0 11.111c0 3.497 1.745 6.616 4.472 8.652V24l4.086-2.242c1.09.301 2.246.464 3.442.464 6.627 0 12-4.974 12-11.111S18.627 0 12 0z"/><path d="M12 3.75c-4.556 0-8.25 3.24-8.25 7.236 0 2.164 1.128 4.1 2.89 5.336l-.422 2.266 2.628-1.442c.822.316 1.712.478 2.638.478 4.556 0 8.25-3.24 8.25-7.236S16.556 3.75 12 3.75z" fill="none" stroke="currentColor" strokeWidth="1.5"/></svg> },
    ...
    { name: 'Email', href: `mailto:?subject=${encodeURIComponent(shareTitle)}&body=${encodedShare}`, color: '#EA4335',
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 4l-10 8L2 4"/></svg> },
