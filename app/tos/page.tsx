    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-muted-foreground text-sm space-y-6">
          ...
          <p>Artists deposit funds into campaigns via Stripe. Creators submit content for review. Artists approve or reject submissions. Approved content earns CPM-based payouts for verified views only. A 20% platform fee is added to the artist's CPM rate (e.g., $1,000/1M CPM → artist pays $1,200, creator receives full $1,000). Artists are never charged above their campaign budget. Example: $500 campaign at $1,000/1M CPM → creator earns full CPM, platform fee of $100 added to artist cost. Payouts to creators are processed on a net-7 basis after view verification.</p>
