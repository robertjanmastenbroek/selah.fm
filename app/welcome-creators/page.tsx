      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 py-20 text-center relative z-10">
          ...
          <motion.p className="text-lg text-muted-foreground max-w-xl mx-auto mb-4 leading-relaxed" initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.2}}>
            Browse music from independent artists, make a TikTok or Reel with it, and earn per verified view. No brand deals. No minimum followers. Payouts via Stripe from $5. Just real money for your content.
          </motion.p>
      ...
      <SectionWrap>
        ...
        <div className="max-w-4xl mx-auto px-6 grid md:grid-cols-3 gap-8">
          {[
            ...
            { step: '03', icon: DollarSign, title: 'Earn Per View', desc: 'Artist approves your video. You earn per 1,000 verified views. Paid via Stripe once you reach $5 total.' }
          ].map((s, i) => {
            const I = s.icon;
            return (
      ...
      <SectionWrap>
        ...
        <div className="max-w-4xl mx-auto px-6 grid md:grid-cols-3 gap-6">
          {[
            ...
            { icon: Wallet, title: '$5 Minimum Payout', desc: 'Your submissions add up. Once your total approved earnings reach $5, we send the payout via Stripe. No micro-payments, no withdrawal fees eating your earnings.' },
          ].map((item, i) => {
            const I = item.icon;
            return (
