...
export default function WelcomeCreatorsPage() {
  return (
    <div className="min-h-screen text-foreground overflow-x-hidden" style={{ background: '#0F0F23' }}>
      ...
      {/* FEES */}
      <SectionWrap>
        <motion.div className="text-center mb-16" variants={fadeUp}><h2 className="text-3xl md:text-4xl font-heading tracking-tight mb-4">You keep 100% of every payout.</h2><p className="text-muted-foreground">The full CPM rate goes to you. The platform fee is added on the artist's side — you never lose a cent.</p></motion.div>
        <div className="max-w-lg mx-auto px-6"><div className="rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.06] overflow-hidden text-center p-10"><div className="flex items-end justify-center gap-3 mb-6"><div className="w-36 h-36 rounded-2xl flex items-center justify-center text-black text-4xl font-bold" style={{ background: 'linear-gradient(135deg, #22C55E, #4ADE80)' }}>100%</div></div><p className="text-sm">Creators earn the full CPM rate. The 20% platform fee is added on the artist's side — you keep every cent you earn.</p><p className="text-xs text-muted-foreground mt-3">Connect Stripe in under 2 minutes. Payouts process automatically.</p></div></div>
      </SectionWrap>
