      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="rounded-xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.06] p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between"><span className="text-sm text-muted-foreground">Platform revenue (25%)</span><span className="font-semibold text-primary">${platformRev.toFixed(2)}</span></div>
